...
public enum PluginKey
{
    ...
    // === Behavior Tree Nodes ===
    // Execution (with MonoBehaviour)
    BtNodeMono_MovementNavMesh,     // Move (and also rotate) to target using NavMesh
    BtNodeMono_ImpulseRigidbody,    // Move using physics impulse

    BtNodeModifier_Movement,
